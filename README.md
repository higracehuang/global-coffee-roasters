...
| Name | Location | Shipping | Style | Notes |
| --- | --- | --- | --- | --- |
| [Happy Mug](https://happymugcoffee.com/) | Erie | [Free over $40. $3 on all orders](https://happymugcoffee.com/pages/shipping-table) | LMD, Green | Tours and tastings are available with appointment. |
...
| [Toby's Estate Coffee](https://www.tobysestate.com.au/) | Sydney, NSW | Free over $65. Only ships to Australia and Singapore | SO, LMD | World's Best Coffee Shop 2025 (Madrid, Spain). |

### Queensland

| Name | Location | Shipping | Subscription | Style | Notes |
| --- | --- | --- | --- | --- | --- |
| [Kai](https://www.kaicoffee.com/) | Warana, QLD | Free on All Orders | $27+FS (500g) | SO, LMD |  |
...
- **Data (coffee roaster information in this README)**: CC BY 4.0 — you may share and adapt it **as long as you credit this repository**.  
- **Code / templates** (if any): MIT License.

For details, see [DATA_LICENSE.md](DATA_LICENSE.md).
